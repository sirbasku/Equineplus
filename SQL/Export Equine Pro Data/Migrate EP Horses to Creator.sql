...
WHERE t.HorseName LIKE '%HORSE%'

SELECT * FROM user_Horse where HorseName = 'HORSE NAME'


*/

select * from base_lookup where lookupid = '3C13EE2E-EA12-4F80-AE2F-147B5798F719'
